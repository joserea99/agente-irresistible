        ...
        <DashboardLayout>
            <div className="space-y-6">
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-muted-foreground">Gestiona usuarios, conocimiento y herramientas del sistema.</p>
                </div>
                                        ...
                                        {syncStatus.status !== "never_run" && (
                                            <>
                                                ...
                                                <div className="flex gap-4 pt-1">
                                                    ...
                                                    <span className="text-muted-foreground">Omitidos: {syncStatus.skipped ?? 0}</span>
